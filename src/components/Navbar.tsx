  ...
  return (
    <header className="nav">
      <Link href="/" className="nav-brand">
        <span>🧠</span> AMHS — Anonymous Mental Health Survey
      </Link>
      <div className="nav-links">
        <Link href="/" className={"nav-link " + (pathname === "/" ? "active" : "")}>Dashboard</Link>
        <Link href="/claim" className={"nav-link " + (pathname === "/claim" ? "active" : "")}>Take Survey</Link>
        <Link href="/admin" className={"nav-link " + (pathname === "/admin" ? "active" : "")}>Surveyor Console</Link>
